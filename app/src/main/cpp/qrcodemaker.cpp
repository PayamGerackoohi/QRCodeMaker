...
Java_com_payamgr_qrcodemaker_data_NativeQrCodeMakerImpl_text(JNIEnv *env, jobject, jstring jText, jint jEcc) {
...
Java_com_payamgr_qrcodemaker_data_NativeQrCodeMakerImpl_phoneCall(JNIEnv *env, jobject, jstring jPhone, jint jEcc) {
...
extern "C"
JNIEXPORT jobject JNICALL
Java_com_payamgr_qrcodemaker_data_NativeQrCodeMakerImpl_meCard(JNIEnv *env, jobject, jobject jMeCard, jint jEcc) {
